  ...
  return (
    <div className='userdashboard w-full bg-white relative'>
      ...
      <div className='w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-7 gap-4 p-4'>
        <StatisticsColumn className='col-span-3' setShowMail={setShowMail} showMail={showMail} setShowAddMail={setShowAddMail} setShowBoard={setShowBoard} setShowDiscuss={setShowDiscuss}/>
