...
const AddProjectModal = ({ setShowAddProjectModal }) => {
  ...
  async function handleAddProject(e) {
    ...
    if (!formData.projectName || !formData.teamName || !formData.projectType || !formData.projectDuration || !formData.projectStatus || !formData.teamSize || formData.roles.length === 0 || formData.skills.length === 0) {
